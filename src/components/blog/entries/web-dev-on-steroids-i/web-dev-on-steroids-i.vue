<template>
    ...
    >
        <p>
            ...
            development. In this post I will explain some of the techniques we use at
            <b>Sage</b> to develop our web platforms, both front end and back end, which I've later
            on exported to my personal projects too. Keep reading to streamline your own development
            experience!
        </p>
        ...
        <div v-if="!isRenderedFromList">
            <p>
                ...
                Be aware that I am using
                <b>Visual Studio Code</b>, so the solutions I provide are based on that particular
                IDE. If you prefer other choices, you will have to investigate the available tools
                out there, but the concepts are still applicable. That being said, let's rock and
                roll 🤩
            </p>

            <p class="text-center">
                <img :src="`/vue-personal-page/${images.letsGo}`" alt="Enthusiastic men shouting" />
            </p>
            ...
            <p>
                ...
                build process to your development pipline, why not investing a bit more effort and
            ...
            <p>
                ...
                <a href="https://palantir.github.io/tslint/" target="_blank">Typescript</a>. A very
                cool aspect of using Typescript with an appropriate IDE is that you get a list of
                all the attributes and methods available in an object when you type, a feature also
                known as Intellisense. Once you try it, you will never be able to develop without it
                again!
            </p>

            <p class="text-center">
                <img
                    :src="`/vue-personal-page/${images.intellisense}`"
            ...
            <ul>
                ...
                <li>
                    Add a
                    <b>tsconfig.json</b> configuration file. If you are migrating an existing
                ...
                <li>
                    ...
                    webpack, so this is how the story goes
            ...
            <p>
                ...
                single quotes or arguing with your collegues about how to format ternary expressions
                and lines maximum length. Put a formatter that integrates with your IDE in place and
                it will save you priceless amounts of time while enforcing a standard code
                guideline.
            </p>

            <p>
                <a href="https://prettier.io/" target="_blank">Prettier</a> is a popular opinionated
                code formatter that will take care of formatting for you. It allows you to configure
                a few parameters (e.g. maximum line length) but, as it is opinionated, cannot be
                very customized (which will save you stupid dicussion with your teammates). You can
            ...
            <ul>
                ...
                <li>
                    Add a
                    <b>prettier.rc</b> json configuration file with your favourite settings or skip
                    this step if you are fine with prettier default settings
                ...
                <li>
                    ...
                    <b>Require Config</b>
                    property to true so prettier formatting will only be applied to projects that
                    contain a prettier configuration file
            ...
            <p>
                ...
                <a href="https://eslint.org/" target="_blank">eslint</a> is a great linting tool,
                which can be highly customized and manages to automatically fix certain types of
                issues. With a bit of additional confugration it also supports Typescript language,
                which makes it an ideal candidate to replace the deprecated
            ...
            <ul>
                ...
                <li>
                    Configure VSCode to enable the
                    <b>Format On Save</b> option as well as the <b>Format: Enable</b> eslint option
                    by adding the following properties to
                ...
                <li>
                    ...
                    <b>tweak .eslintrc.js</b> file to meet your needs, specially if you are using
            ...
            <p>
                ...
                as
                <i>el</i>, <i>doc</i>, <i>i</i> and use words with actual meaning: <i>element</i>,
                <i>document</i>, <i>index</i>. And in case you are already paying extreme attention
                to variable names, even the most literate software engineer introduce typos when
                they code.
            </p>
            ...
            <p>
                ...
                amazing
                <b>Code Spell Checker</b> tool. It will point out invalid words and typos, and it
                also recognizes the camel case convention so it will understand
