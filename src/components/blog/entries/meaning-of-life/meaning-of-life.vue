<template>
    ...
    >
        ...
        <div v-if="!isRenderedFromList">
            <p class="text-center">
                <img
                    :src="`/vue-personal-page/${images.crazy}`"
            ...
            <p>
                ...
                it would have a drawback too because we wouldn't explore as many possibilites as we
                do now (e.g. to quote an extravagant experiment, we sent a Tesla across the
                universe, can you believe it!?).
            </p>
            <p class="text-center">
                <img :src="`/vue-personal-page/${images.teslaInSpace}`" alt="Tesla car in space" />
            </p>
            <p>
            ...
            <p class="text-center">
                <img
                    :src="`/vue-personal-page/${images.stringTheory}`"
            ...
            <p>
                ...
                doomed to an eventual extinction due to the unfitness of their behaviours. So, like
            ...
            <p>
                ...
                choosen by you, which makes it meaningful, and that will keep you focus and
                motivated for as long as you decide. Finally, the more you learn, the better you
                understand the world that surrounds you and the more connections you will find
                between apparently unrelated things. So don't worry too much about finding the
                meaning of life and go learning something out there! See you in the next post
            </p>
        </div>
    </BlogEntry>
</template>
