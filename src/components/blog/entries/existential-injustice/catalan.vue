        ...
        <div v-if="!isRenderedFromList">
            ...
            <p>
                <b
                    ...
                    transcendental amb la teva vida</b
            ...
            <div class="row">
                <div class="col-md-10 offset-md-1">
                    <br />
                    <h4>
                        &#x275D;Un objectiu no sempre es marca per aconseguir-lo, sovint serveix
                        només per tenir una direcció cap on apuntar&#x275E;
                    </h4>
                    <h4>- Bruce Lee</h4>
                    <br />
                </div>
            ...
            <p>
                <b>2) Estàs a un nivell energètic molt inferior del que necessites per progressar</b
