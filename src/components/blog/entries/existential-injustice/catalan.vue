<template>
    ...
    >
        ...
        <div v-if="!isRenderedFromList">
            <p>Comences a sentir que podries estar fent alguna altra cosa, aprofitar millor el temps d'una altra manera. Dedicar-te unes hores a aquell projecte personal que estas ajornant o allargant. Potser acabar el llibre que estas llegint. Poster anar al gimnàs. Potser començar la teva carrera com a novelista. Intentes descartar la idea i centrar-te en el moment. Poses una mica més d'èmfasi en recuperar la sinergia amb les persones que estas.</p>
            <p>Passa una altra hora i t'adones que esteu cansats o que teniu el cap a una altra banda. Així no és com t'havies imaginat que aniria la tarda. Decideixes tornar a casa i treure profit al que queda de dia. És dissabte a les 19. Potser encara falta estona per què es faci fosc. Potser ja fa estona que el sol s'ha post. De totes maneres, tens temps de posar-t'hi.</p>
            <p>Tanmateix, el teu cervell no està per la labor. Demà t'has compromès a assistir a una activitat. Potser anar a un parc d'atraccions. Potser una barbacoa. Potser un dinar amb la familia de la teva parella. En qualsevol cas, ara tens la ment ocupada quantificant el nivell de mandra que et provoca aquest compromís. Preveus que tornaràs tard a casa, exhaust, i que, una vegada més, t'adonaràs que ha passat el cap de semana volant i que segueixes en el mateix punt on estaves el diumenge anterior.</p>
            <p>
                <b>Fins i tot si ara poguessis dedicar una estona al teu projecte, no podries avançar prou</b>. Els quatre forats al mes que trobes no son suficient per aconseguir el teu objectiu. I encara que ara aconseguissis expolsar-te la mandra de sobre,
                <b>estàs a un nivell energètic molt inferior del que necessites per progressar</b>. No. Definitivament, avui no és el dia. T'entregues a la sensació d'impotència i et passes les hores que li queden a la tarda jugant a videojocs o mirant la útlima serie de Netflix.
            </p>
            <p>
                <b>Notes que el temps se t'escapa de les mans i no aconsegueixes fer res trascendental amb la teva vida</b>. És una sensació abrumadora, però no és culpa teva que et sentis així. Prens notes mentals de determinació i decideixes que el cap de setmana que ve t'hi posaràs. Merda. El cap de setmana que ve és el de l'excursió a la muntanya que fa més d'un mes que heu organitzat. No és que no et vingui de gust. De fet, en tens moltes ganes. Però et preguntes quan tindràs temps per tu. Perquè les estrelles s'alinean i no trobes mai l'espai que necessites per dedicar-te a les teves ambicions? Tens tantes coses per aportar al mon...
            </p>
            <p>Ha passat la tarda sense pena ni glòria. Si no et comences a fer el sopar aviat aniràs a dormir a les tantes i demà no t'aguantaràs. Però que més dona? Sembla que no tens cap poder real sobre el curs dels esdeveniments. No tens ganes de fer res. No tens energia. No és just. A la merda el cansament de demà.</p>
            ...
            <p>També pots fer l'exercici de rebaixar les expectatives que hi tens posades. Assumir que completaràs el projecte per sota del estàndards que t'havies proposat. Sovint la sensació de no poder avançar prou apareix quan l'objectiu sembla estar massa lluny. Busca una manera de completar-lo en una forma més simple (deixa les cançons de Metallica per més endavant, i comença amb una base senzilla dels U2).</p>
            <p>Potser aconseguiràs acabar-lo en una forma simplificada. Després, si encara no en tens prou amb el resultat, sempre pots seguir-hi treballant per arribar a la meta original. També pot ser que t'adonis que no necessites el nivell d'excel·lència que havies imaginat en un primer moment. De totes maneres, completar un objectiu encara que sigui petit et donarà una bona dosi de motivació i et farà sentir bé.</p>
            <p>
            ...
            <p>Aixo es tot per avui 👍 Fins al proper post!</p>
        </div>
    </BlogEntry>
</template>
