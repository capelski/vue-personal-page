<template>
    <div>
        <p>
            ...
            <a href="https://en.wikipedia.org/wiki/Sudoku" target="_blank">sudoku</a>. Dos de fet;
            un de dificultat raonable i un de completament malvat. Va ser mentre ella estava
            enfeinada resolent el primer sudoku que la vaig interrompre. No recordo que volia en
            aquell moment, però si que recordo que vam parlar del sudoku i que em vaig fixar en la
        ...
        <div v-if="!isRenderedFromList">
            ...
            <p>
                ...
                <b
                    ...
                    lliure de la que mai hagués disposat</b
                >
            ...
            <p>
                ...
                estar apunt de donar el projecte per perdut vàries vegades però, per sort, vaig
                mirar
                <a href="https://www.imdb.com/title/tt4276820/" target="_blank">The Founder</a>
                ...
                bales. La veritat sigui dita, aquesta odissea va tenir quatre fases:
            </p>
            ...
            <p>
                ...
                <a href="/sudoku-generator" target="_blank">generador de sudokus</a>. He d'admetre
                que a vegades arriba a carrerons sense sortida durant la generació, havent de
                descartar la feina i començar des de zero, però sempre acaba generant sudokus vàlids
                amb una única solució. En cas que t'ho estiguis preguntant, aquestes són les regles
                que utilitza l'algoritme per generar sudokus. De fet, és probable que siguin també
                les regles que fas servir tu a l'hora de resoldre'ls.
            </p>
            ...
            <p>
                ...
                de saber: no esta adaptat per mòbils i no vaig treballar en regular la dificultat,
                cosa que genera sudokus refotudament complicats. Bona sort i fins al proper post!
            </p>
        </div>
    </div>
</template>
