<template>
    <div>
        <p>
            My mother has always been a fervent newspaper reader and she is in the habit of solving
            the puzzles that come in the last pages. Between those puzzles you can always find a
            game called
            <a href="https://en.wikipedia.org/wiki/Sudoku" target="_blank">sudoku</a>. Two actually;
            a reasonably difficult one and an evil one. So she was in the middle of filling the
            first sudoku when I interrupted her. I don't remember what for but I do remember that we
        ...
        <div v-if="!isRenderedFromList">
            ...
            <p>
                In the particular newspaper my mom was reading that day, the easy sudokdu had 28
            ...
            <p>
                ...
                have
                <a href="https://www.sudokuwiki.org/Sudoku_Creation_and_Grading.pdf" target="_blank"
                    >1905 possible solutions</a
                >. That anecdote aroused my curiosity.
            </p>
            <p class="text-center">
                <img
                    :src="`/vue-personal-page/${images.skyTvHillside}`"
            ...
            <p>
                ...
                <b>and finallly gave up</b>. Nevertheless I had just started a sabbatical leave at
                my company and, due to COVID-19 prevention measures, the one way flight I was
                supposed to catch on March 31st to go living in Australia got cancelled.
                <b
                    >Given I found myself unemployed, locked at home and provided with the biggest
                    amount of free hours I had ever had in my life</b
                >
                (in Spain the coronavirus lockdown started March 15th and it was meant to last at
            ...
            <p>
                ...
                was about to quit the project many times but, luckily, I watched
                <a href="https://www.imdb.com/title/tt4276820/" target="_blank">The Founder</a> in
                the meanwhile, the movie that explains how Ray Kroc turned McDonald's into the
                biggest restaurant business in the world thanks to his bulletproof persistence. If
                you must know, this odyssey had four stages:
            </p>
            ...
            <p class="text-center">
                <img
                    ...
                    :src="`/vue-personal-page/${images.commandLine}`"
            ...
            <p class="text-center">
                <img
                    class="limited-size-image"
                    :src="`/vue-personal-page/${images.commandLineError}`"
            ...
            <p class="text-center">
                <img
                    class="limited-size-image"
                    :src="`/vue-personal-page/${images.webAppFirstApproach}`"
            ...
            <p>
                ...
                it, as I should have done from the beginning, I figured out some of those dervied
                rules that help discarding possible numbers from boxes. Having found out about those
                little bastards, it was just a matter of rewritting the algorithm to consider them.
                It took me a number of hours, but I could finally get a working generator.
            </p>
            <p class="text-center">
                <img
                    class="limited-size-image"
                    :src="`/vue-personal-page/${images.webAppFinalApproach}`"
            ...
            <p>
                ...
                this humble
                <a href="/sudoku-generator" target="_blank">sudoku generator</a>. I must admit that
                it sometimes reaches dead ends during generation, having to drop the work and start
                again from scratch, but it always ends up generating valid single solution puzzles.
                If you are wondering, these are the rules the algorithm uses to generate sudoku. In
                fact, these are probably the rules you use when you are solving those puzzles too.
            </p>
            ...
            <ul>
                <li>
                    ...
                    <p class="text-center">
                        <img
                            class="limited-size-image"
                            :src="`/vue-personal-page/${images.boxOnlyLeftCandidate}`"
                            alt="Web application final approach"
                        />
                    </p>
                </li>
                <li>
                    ...
                    <p class="text-center">
                        <img
                            class="limited-size-image"
                            :src="`/vue-personal-page/${images.groupSingleCandidate}`"
                            alt="Web application final approach"
                        />
                    </p>
                </li>
                <li>
                    ...
                    <p class="text-center">
                        <img
                            class="limited-size-image"
                            :src="`/vue-personal-page/${images.ownedCandidates}`"
                            alt="Web application final approach"
                        />
                    </p>
                </li>
                <li>
                    ...
                    <p class="text-center">
                        <img
                            class="limited-size-image"
                            :src="`/vue-personal-page/${images.regionSubset}`"
                            alt="Web application final approach"
                        />
                    </p>
                </li>
            ...
            <p>
                ...
                acceptable sudoku generator. It was finally less complete than what I wanted it to
                be, but things never turn out the way you expect them to. Feel free to use the
                generator, but there two things you must know: it isn't mobile friendly and I didn't
                work on configuring the difficulty, which makes the generated puzzles pretty
                hardcore. Good luck and see you in the next post!
            </p>
        </div>
    </div>
</template>
