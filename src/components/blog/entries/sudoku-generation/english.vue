    ...
    <div>
        <p>
            ...
            <a
                ...
                target="_blank"
            >sudoku</a>. Two actually; a reasonably difficult one and an evil one. So mom was in the middle of filling the first sudoku when I came asking her for something. I don't remember what that question was now, but I do remember that we talked about sudoku and it was the difference between the two sudoku levels that caught my attention.
        </p>
        <div v-if="!isRenderedFromList">
            ...
            <p>
                In fact, it turns out is not easy at all. An important property of a well-composed sudoku is that it must have a single solution. It might sound obvious, but depending on how the numbers are placed in the boxes, there can be multiple valid combinations that solve the puzzle. The most famous example was the sudoku that UK Sky TV draw in a hillside offering a £5000 prize; it turned out to have
                <a
            ...
            <p>
                ...
                <b>and finallly gave up</b>. It happened to happen though that I had just started a sabbatical leave at my company and my one way flight to Australia for March 31st got cancelled because of COVID-19 prevention measures.
            </p>

            <p>
                Given
                <b>I found myself unemployed, locked at home</b> (in Spain the lockdown started March 15th and it was meant to last at least for one month)
                <b>and provided with the biggest amount of free hours I had ever had in my life</b>, I decided to investigate the sudoku generation subject for a while.
            </p>
