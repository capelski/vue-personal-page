<template>
    ...
    >
        <p>
            ...
            <b>project management</b> practice. With it's <b>never ending meetings</b>, the excess
            of <b>control mechanisms</b> and the recurrent <b>mail chains</b> it is certainly not
            the most popular system between the employees. Far from perfect however, it let to some
            techniques that are simple and effective when it comes to goals management.
        </p>
        <div v-if="!isRenderedFromList">
            ...
            <p>
                ...
                <b>Pending</b>, <b>In Progress</b> and <b>Done</b>. The three columns can have any
                names and you might find any number of additional columns (e.g. in software
                engineering we add columns to represent the different stages of a task development:
                implementation, testing, deployment, etc.). This is an empty Kanban board:
            </p>
            ...
            <p>
                ...
                <a href="https://trello.com/" target="_blank">Trello</a>. Trello boards can have any
                number of lists and each list contains cards that are much more powerful than just
                plain text: you can attach pictures, you can share them, you can label them, you can
                create check lists, etc. This is what my books Kanban board looks like in Trello:
            </p>
            <p class="text-center">
                <img
                    :src="`/vue-personal-page/${images.trelloBoard}`"
            ...
            <div class="kanban-board">
                <div class="row">
                    ...
                    <div class="col-sm-4 order-sm-6" style="text-decoration: line-through;">
