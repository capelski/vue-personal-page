<template>
    ...
    >
        <p>
            ...
            non-technical audience, I was uploading some kind of password to a social network
            profile), allowing any smartass clever enough to find it to spend my Google Maps quota
            on his behalf.
        </p>
        <div v-if="!isRenderedFromList">
            <p class="text-center">
                <img
                    :src="`/vue-personal-page/${images.googleMail}`"
            ...
            <ul>
                <li>
                    ...
                    <a href="https://github.com/xkjyeah/vue-google-maps/issues/472" target="_blank"
                        >reporting the Webpack failure</a
                    >
            ...
            <p>
                ...
                <b>dotenv</b> (or any similar tool) to define the API key as an environment variable
                and keep it away from Github. If you have never used it before, it allows you to
                define properties in a <b>.env</b> file (which must be excluded from Github) and
                then load them to the <b>process.env</b> nodejs global object. Finally, to be sure
                that I don't break my website by forgetting to define the key in the .env file (or
                more exactly, to create the whole .env file), I added the following check to the
            ...
            <p>
                ...
                keep Google happy. Please contact me at
