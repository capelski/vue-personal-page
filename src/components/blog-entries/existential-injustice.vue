<template>
    ...
    >
        <div v-if="!isRenderedFromList" class="alert alert-warning text-center" role="alert">
            You can also read this post in <router-link :to="`/blog/injusticia-existencial`">catalan</router-link>
        </div>
        <p>
        ...
        <div v-if="!isRenderedFromList">
            ...
            <p>
                <b>Even if you would manage to allocate some time to your project now, you wouldn't progress enough</b>. The few time slots you find on a monthly basis are not enough to complete your project. Also, based in the assumption that you could overcome the laziness now, <b>your energy levels are way below the ones you need to work properly on it</b>. No. Definitely today is not the day. You give in to the impotence feeling and spend the rest of the day playing videogames or watching the latest Netflix TV show.
            </p>
            <p>
