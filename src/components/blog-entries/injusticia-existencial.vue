<template>
    ...
    >
        ...
        <div v-if="!isRenderedFromList">
            ...
            <p>
                Tanmateix, el teu cervell no està per la labor. Demà t'has compromès a assistir a una activitat. Potser anar a un parc d'atraccions. Potser una barbacoa. Potser un dinar amb la familia de la teva parella. En qualsevol cas, ara tens la ment ocupada quantificant el nivell de mandra que et provoca aquest compromís. Preveus que tornaràs tard a casa, exhaust, i que, una vegada més, t'adonaràs que ha passat el cap de semana volant i que segueixes en el mateix punt on estaves el diumenge anterior.
            </p>
            <p>
                <b>Fins i tot si ara poguessis dedicar una estona al teu projecte, no podries avançar prou</b>. Els quatre forats al mes que trobes no son suficient per aconseguir el teu objectiu. I encara que ara aconseguissis expolsar-te la mandra de sobre, <b>estàs a un nivell energètic molt inferior del que necessites per progressar</b>. No. Definitivament, avui no és el dia. T'entregues a la sensació d'impotència i et passes les hores que li queden a la tarda jugant a videojocs o mirant la útlima serie de Netflix.
            </p>
            <p>
            ...
            <p>
                Ha passat la tarda sense pena ni glòria. Si no et comences a fer el sopar aviat aniràs a dormir a les tantes i demà no t'aguantaràs. Però que més dona? Sembla que no tens cap poder real sobre el curs dels esdeveniments. No tens ganes de fer res. No tens energia. No és just. A la merda el cansament de demà.
            </p>
            <p>
                Truques a un restaurant amb servei a domicili i demanes que et portin el sopar. Si aquest és l'únic temps lliure que tindràs no te'l penses passar cuinant i rentant plats. Et miraràs un capitol més de la serie mentre esperes la pizza. El sopar triga a arribar. Hi ha més gent en la mateixa situació que tu i els restaurants no donen l'abast. Acabes ficant-ne al llit més tard del que voldries i preguntant-te on coi han anat totes les hores lliures que tenies.
            </p>
            <p>
