<template>
    ...
    >
        ...
        <div v-if="!isRenderedFromList">
            ...
            <p class="text-center">
                <img :src="`/img/blog/${entry.id}-tesla-in-space.jpg?$modena=vue-personal-page`" alt="Tesla car in space" />
            </p>
            <p>
            ...
            <p class="text-center">
                <img :src="`/img/blog/${entry.id}-string-theory.jpg?$modena=vue-personal-page`" alt="String theory representation" />
            </p>
            <p>
