<template>
    <div class="blog-entry">
        ...
        <p class="text-center">
            <br />
            <img class="google-mail-img" src="/img/blog/leaked-api-key_google_mail.png?$modena=vue-personal-page" />
            <br />
            <br />
        </p>
        <p>
        ...
        <p>
            My page is using Vue + Webpack so chances were high that I would find a handy library on npm. A <a href="https://www.npmjs.com/search?q=vue%20google%20maps" target="_blank">quick npm search</a> returns many potentially interesting results. I gave a chance to the following two:
        </p>
        <ul>
            <li><b>vue2-google-maps</b>: This one was making Webpack build to fail. I went to the Github repository opened issues (245 at the time of writing) and I found one <a href="https://github.com/xkjyeah/vue-google-maps/issues/472" target="_blank">reporting the Webpack failure</a> which had been seating there for almost a year</li>
            <li><b>vue-googlemaps</b>: This one gave me a better start and I could get to make it work on development mode. However, when building and deploying the app on production mode I was getting a "You have included the Google Maps JavaScript API multiple times on this page" error which would make the Map to break</li>
        </ul>
        <p>
    ...
    export default {
        ...
        mounted() {
            monaco.editor.create(this.$refs.initialIndex, {
                ...monacoOptions,
                // In order that webpack doesn't complain because of unresolvable scripts,
                // we provide the Html encoded. See leaked-api-key_initial_index.html
