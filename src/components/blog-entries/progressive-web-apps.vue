    ...
    >
        ...
        <div v-if="!isRenderedFromList">
            ...
            <p>
                ...
                <b>Network falling back to cache</b> strategy, will happen only if the corresponding network request fails (lines 42-44). Don't forget to add the asset to the cache on a successful network response in order to keep the cache content updated (line 38). The
